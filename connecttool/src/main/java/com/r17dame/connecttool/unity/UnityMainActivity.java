package com.r17dame.connecttool.unity;
...
//        setContentView(R.layout.activity_main);
        ...
        try {
            ...
            GetPurchaseOrderListButton = findViewById(com.r17dame.connecttool.R.id.GetPurchaseOrderListButton);
            ...
            // 查詢儲值訂單資訊 tradeNo 必填
            GetPurchaseOrderButton = findViewById(com.r17dame.connecttool.R.id.GetPurchaseOrderButton);
            ...
            // 查詢使用點數訂單 交易編號
            // 測試參考 :
            QueryConsumeSPButton = findViewById(com.r17dame.connecttool.R.id.QueryConsumeSPButton);
