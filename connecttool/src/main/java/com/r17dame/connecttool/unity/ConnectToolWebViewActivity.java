...
public class ConnectToolWebViewActivity extends UnityPlayerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                // 設定登入測試
                String Input_Email = "jianwei.ciou@gmail.com";
                ...
                Input_Password = "Abc-123456";
                Input_ConfirmPassword = "Abc-123456";
